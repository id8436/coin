...
def dbgout(message):
    """인자로 받은 문자열을 파이썬 셸과 슬랙으로 동시에 출력한다."""  # 슬렉으로 보내는 거라 필요없을듯.
...
if __name__ == '__main__': 
    try:
        symbol_list = ['A122630', 'A252670', 'A233740', 'A250780', 'A225130',
             'A280940', 'A261220', 'A217770', 'A295000', 'A176950']  # 자동매매를 하고자 하는 종목코드.
        bought_list = []     # 매수 완료된 종목 리스트
        target_buy_count = 5 # 위 종목 중 매수할 종목 수
        buy_percent = 0.19   # 각각의 종목은 현재 재화의 몇퍼센트까지?
        ...
        while True:
            ...
            t_sell = t_now.replace(hour=15, minute=15, second=0, microsecond=0) # 팔 시간
            t_exit = t_now.replace(hour=15, minute=20, second=0,microsecond=0)  # 종료시간
