...
class InfoMachine:
    ...
    def ticker_list(self, get_df=None):
        '''코드를 받아 티커정보 반환.'''
        from j1_0_0_get_origin_data.base_data.ticker import list_of_crypto, list_of_stock
    ...
    def find_stock_by_code(self, code_list):  # 이것도 따로 빼면 좋을까..
        ...
        from j1_0_0_get_origin_data.base_data.ticker import find_stock_by_code
